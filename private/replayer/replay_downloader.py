...
class ReplayDownloader(Thread):
    ...
    def run(self):
        ...
        self._replay_service.init_replay(self._replay)
        self._replay.state = 'downloading'
        try:
    ...
    def _download_chunks(self):
        ...
        if end > 6:
            ...
            start = 1
        logging.info('_download_chunks start: ' + str(start) +
                     ' stop: ' + str(end))
    ...
    def _download_chunk_worker(self, chunk_id):
        ...
        for trys in range(0, self._RETRIES_LIMIT):
            ...
            if chunk_data:
                ...
                self._replay_service.add_data_chunk(self._replay,
                                                    chunk_id,
                                                    chunk_data)
